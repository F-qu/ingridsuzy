...
<body>
   ...
   <div class="heading">
      <h3><a style="color: #666;" onmouseout='this.style.color="#666"' onmouseover='this.style.color="#fff"' href="cart.php">shopping cart > </a>checkout </h3>
   </div>
   ...
   <section class="checkout">
      ...
      <form action="" method="post">
         ...
         <div class="flex">
            ...
            <div class="inputBox">
               <span>address :</span>
               <input type="number" min="0" name="flat" required placeholder="enter your address.">
            </div>
            <div class="inputBox">
               <span>city :</span>
